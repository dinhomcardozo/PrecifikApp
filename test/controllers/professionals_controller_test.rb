...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference("Professional.count") do
      post professionals_url, params: { professional: {  average_hourly_rate: @professional. average_hourly_rate,  cnpj: @professional. cnpj,  company_name: @professional. company_name,  cpf: @professional. cpf,  full_name: @professional. full_name,  hourly_rate: @professional. hourly_rate,  role_id: @professional. role_id } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: {  average_hourly_rate: @professional. average_hourly_rate,  cnpj: @professional. cnpj,  company_name: @professional. company_name,  cpf: @professional. cpf,  full_name: @professional. full_name,  hourly_rate: @professional. hourly_rate,  role_id: @professional. role_id } }
