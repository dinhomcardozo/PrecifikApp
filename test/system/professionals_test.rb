...
class ProfessionalsTest < ApplicationSystemTestCase
  ...
  test "should create professional" do
    ...
    fill_in "Average hourly rate", with: @professional. average_hourly_rate
    fill_in "Cnpj", with: @professional. cnpj
    fill_in "Company name", with: @professional. company_name
    fill_in "Cpf", with: @professional. cpf
    fill_in "Full name", with: @professional. full_name
    fill_in "Hourly rate", with: @professional. hourly_rate
    fill_in "Role", with: @professional. role_id
